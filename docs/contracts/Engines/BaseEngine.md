...
[BaseEngine-computeStateForEvent-struct-ACTUSTypes-LifecycleTerms-struct-ACTUSTypes-State-bytes32-bytes32-]: #BaseEngine-computeStateForEvent-struct-ACTUSTypes-LifecycleTerms-struct-ACTUSTypes-State-bytes32-bytes32-
[BaseEngine-computePayoffForEvent-struct-ACTUSTypes-LifecycleTerms-struct-ACTUSTypes-State-bytes32-bytes32-]: #BaseEngine-computePayoffForEvent-struct-ACTUSTypes-LifecycleTerms-struct-ACTUSTypes-State-bytes32-bytes32-
...
## <span id="BaseEngine"></span> `BaseEngine`

Implements computeStateForEvent and computePayoffForEvent for all Engines.
...
### <span id="BaseEngine-computeStateForEvent-struct-ACTUSTypes-LifecycleTerms-struct-ACTUSTypes-State-bytes32-bytes32-"></span> `computeStateForEvent(struct ACTUSTypes.LifecycleTerms terms, struct ACTUSTypes.State state, bytes32 _event, bytes32 externalData) → struct ACTUSTypes.State` (public)
...
### <span id="BaseEngine-computePayoffForEvent-struct-ACTUSTypes-LifecycleTerms-struct-ACTUSTypes-State-bytes32-bytes32-"></span> `computePayoffForEvent(struct ACTUSTypes.LifecycleTerms terms, struct ACTUSTypes.State state, bytes32 _event, bytes32 externalData) → int256` (public)
