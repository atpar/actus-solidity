...
[ContractDefaultConvention]: #ContractDefaultConvention
[ContractDefaultConvention-performanceIndicator-enum-ACTUSTypes-ContractPerformance-]: #ContractDefaultConvention-performanceIndicator-enum-ACTUSTypes-ContractPerformance-
...
## <span id="ContractDefaultConvention"></span> `ContractDefaultConvention`
...
### <span id="ContractDefaultConvention-performanceIndicator-enum-ACTUSTypes-ContractPerformance-"></span> `performanceIndicator(enum ACTUSTypes.ContractPerformance contractPerformance) → int8` (internal)

Returns the performance indicator for a given performance
