...
[ContractRoleConvention]: #ContractRoleConvention
[ContractRoleConvention-roleSign-enum-ACTUSTypes-ContractRole-]: #ContractRoleConvention-roleSign-enum-ACTUSTypes-ContractRole-
...
## <span id="ContractRoleConvention"></span> `ContractRoleConvention`
...
### <span id="ContractRoleConvention-roleSign-enum-ACTUSTypes-ContractRole-"></span> `roleSign(enum ACTUSTypes.ContractRole contractRole) → int8` (internal)
