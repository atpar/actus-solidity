...
[EndOfMonthConvention-adjustEndOfMonthConvention-enum-ACTUSTypes-EndOfMonthConvention-uint256-struct-ACTUSTypes-IPS-]: #EndOfMonthConvention-adjustEndOfMonthConvention-enum-ACTUSTypes-EndOfMonthConvention-uint256-struct-ACTUSTypes-IPS-
[Core]: ../Core.md#Core
...
## <span id="EndOfMonthConvention"></span> `EndOfMonthConvention`

Implements the ACTUS end of month convention.
...
### <span id="EndOfMonthConvention-adjustEndOfMonthConvention-enum-ACTUSTypes-EndOfMonthConvention-uint256-struct-ACTUSTypes-IPS-"></span> `adjustEndOfMonthConvention(enum ACTUSTypes.EndOfMonthConvention eomc, uint256 startTime, struct ACTUSTypes.IPS cycle) → enum ACTUSTypes.EndOfMonthConvention` (public)

This function makes an adjustment on the end of month convention.


The following is considered to dertermine if schedule dates are shifted to the end of month:
