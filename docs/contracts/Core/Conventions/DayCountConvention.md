...
[BusinessDayConvention]: BusinessDayConvention.md#BusinessDayConvention
[BusinessDayConvention-shiftCalcTime-uint256-enum-ACTUSTypes-BusinessDayConvention-enum-ACTUSTypes-Calendar-]: BusinessDayConvention.md#BusinessDayConvention-shiftCalcTime-uint256-enum-ACTUSTypes-BusinessDayConvention-enum-ACTUSTypes-Calendar-
[BusinessDayConvention-shiftEventTime-uint256-enum-ACTUSTypes-BusinessDayConvention-enum-ACTUSTypes-Calendar-]: BusinessDayConvention.md#BusinessDayConvention-shiftEventTime-uint256-enum-ACTUSTypes-BusinessDayConvention-enum-ACTUSTypes-Calendar-
[BusinessDayConvention-getClosestBusinessDaySameDayOrFollowing-uint256-enum-ACTUSTypes-Calendar-]: BusinessDayConvention.md#BusinessDayConvention-getClosestBusinessDaySameDayOrFollowing-uint256-enum-ACTUSTypes-Calendar-
[BusinessDayConvention-getClosestBusinessDaySameDayOrPreceeding-uint256-enum-ACTUSTypes-Calendar-]: BusinessDayConvention.md#BusinessDayConvention-getClosestBusinessDaySameDayOrPreceeding-uint256-enum-ACTUSTypes-Calendar-
...
[DayCountConvention-yearFraction-uint256-uint256-enum-ACTUSTypes-DayCountConvention-uint256-]: #DayCountConvention-yearFraction-uint256-uint256-enum-ACTUSTypes-DayCountConvention-uint256-
[DayCountConvention-actualActualISDA-uint256-uint256-]: #DayCountConvention-actualActualISDA-uint256-uint256-
[DayCountConvention-actualThreeSixty-uint256-uint256-]: #DayCountConvention-actualThreeSixty-uint256-uint256-
[DayCountConvention-actualThreeSixtyFive-uint256-uint256-]: #DayCountConvention-actualThreeSixtyFive-uint256-uint256-
[DayCountConvention-thirtyEThreeSixty-uint256-uint256-]: #DayCountConvention-thirtyEThreeSixty-uint256-uint256-
[DayCountConvention-thirtyEThreeSixtyISDA-uint256-uint256-uint256-]: #DayCountConvention-thirtyEThreeSixtyISDA-uint256-uint256-uint256-
...
## <span id="DayCountConvention"></span> `DayCountConvention`

Implements various ISDA day count conventions as specified by ACTUS
...
### <span id="DayCountConvention-yearFraction-uint256-uint256-enum-ACTUSTypes-DayCountConvention-uint256-"></span> `yearFraction(uint256 startTimestamp, uint256 endTimestamp, enum ACTUSTypes.DayCountConvention ipdc, uint256 maturityDate) → int256` (internal)

Returns the fraction of the year between two timestamps.



### <span id="DayCountConvention-actualActualISDA-uint256-uint256-"></span> `actualActualISDA(uint256 startTime, uint256 endTime) → int256` (internal)

ISDA A/A day count convention



### <span id="DayCountConvention-actualThreeSixty-uint256-uint256-"></span> `actualThreeSixty(uint256 startTime, uint256 endTime) → int256` (internal)

ISDA A/360 day count convention



### <span id="DayCountConvention-actualThreeSixtyFive-uint256-uint256-"></span> `actualThreeSixtyFive(uint256 startTime, uint256 endTime) → int256` (internal)

ISDA A/365-Fixed day count convention



### <span id="DayCountConvention-thirtyEThreeSixty-uint256-uint256-"></span> `thirtyEThreeSixty(uint256 startTime, uint256 endTime) → int256` (internal)

ISDA 30E/360 day count convention



### <span id="DayCountConvention-thirtyEThreeSixtyISDA-uint256-uint256-uint256-"></span> `thirtyEThreeSixtyISDA(uint256 startTime, uint256 endTime, uint256 maturityDate) → int256` (internal)
